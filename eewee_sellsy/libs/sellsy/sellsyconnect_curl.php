...
class sellsyConnect_curl {
    ...
    private function __construct() {
        ...
        self::$oauth_access_token           = Eewee_Sellsy::getSellsyAccessToken();
        self::$oauth_access_token_secret    = Eewee_Sellsy::getSellsyAccessTokenSecret();
        self::$oauth_consumer_key           = Eewee_Sellsy::getSellsyConsumerToken();
        self::$oauth_consumer_secret        = Eewee_Sellsy::getSellsyConsumerSecret();
        // END : update sellsyConnect_curl
